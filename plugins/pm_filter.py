...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, NO_RESULTS_MSG, CHANNEL_ID, CHANNEL_LINK
...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ɪꜰ yᴏᴜ ɴᴇᴇᴅ ᴍᴏᴠɪᴇ ᴊᴏɪɴ @Filmstudiodl ᴀɴᴅ ᴀꜱᴋ !</b>")
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                mh = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[                          
                          InlineKeyboardButton("⚜️ ʟɪɴᴋꜱ⚜️", url='https://t.me/botdves')
                        ]]
                    )
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ ᴄᴀɴ'ᴛ ᴀᴄᴄᴇss ❓ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ⚠️", url="https://t.me/+GyeIKSkDlio4YjY1")
                        ]
                    ]
                )
            )                    
     ...
     #Any Ertors In Thos Code Contact @Master_broi
       ...
       await query.answer()
        ...
        buttons = [[
            InlineKeyboardButton('⌫ ʙᴀᴄᴋ', callback_data='matrix')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.PIN_TXT,
        ...
        buttons = [[
            InlineKeyboardButton('🪄ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ🪄', url="https://t.me/botdves")
       ],[
            InlineKeyboardButton('🎬ɢʀᴏᴜᴘ🎬', url="t.me/FilmStudiohub2"),
            InlineKeyboardButton('🏅ᴄʜᴀɴɴᴇʟ🏅', url="t.me/Filmstudiodl")
       ],[
            InlineKeyboardButton('📣ʙᴏᴛ ᴜᴩᴅᴀᴛᴇꜱ📣', url="t.me/FilmStudiohub2"),
            InlineKeyboardButton('🤖ꜱᴜᴘᴘᴏʀᴛ🤖', url="https://t.me/FilmStudiohub2")
       ],[
            InlineKeyboardButton('➕️ʜᴇʟᴩ➕️', url="t.me/Filmstudiodl")
       ],[ 
        ...
        buttons = [[
            InlineKeyboardButton('🔥Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ🔥', url='https://t.me/FilmStudiohub2'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⌫ ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/vimukthioshada")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
